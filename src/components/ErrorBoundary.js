...
class ErrorBoundary extends React.Component {
    ...
    render() {
      if (this.state.errorInfo) {
        return (
          <Box my='100' mx='100' p='50' fontSize='20'
          bg='rgba(250, 192, 3, 0.418)' color='rgb(197, 2, 2)'
          ...
          >
            ...
            <Accordion allowToggle maxW='500px'>
              <AccordionItem display='flex' flexDirection='column' >
                ...
                <AccordionButton display='flex' justifyContent='center' mt='10' py='6' px='20'
                bg='rgba(250, 192, 3, 0.418)' borderRadius='5'>
